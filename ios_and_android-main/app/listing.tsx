...
const modules: ModuleCard[] = [
  ...
  { title: '自习室预约', description: '预约自习座位与时段', route: '/space-reservation', Icon: StudyRoomIcon },
];
...
export default function ListingScreen() {
  ...
  useEffect(() => {
    console.log('ListingScreen mounted, Platform:', Platform.OS);
...
function StudyRoomIcon() {
  return (
    <Svg width={28} height={28} viewBox="0 0 32 32" fill="none">
      ...
      />
      <Path
        d="M10 12V9a2 2 0 012-2h8a2 2 0 012 2v3"
        stroke="#7c3aed"
        strokeWidth={1.8}
        strokeLinecap="round"
      />
      <Circle cx={16} cy={19} r={3} stroke="#7c3aed" strokeWidth={1.8} />
      <Path d="M16 18v2.5M14.8 19.8l2.4-1.6" stroke="#7c3aed" strokeWidth={1.5} strokeLinecap="round" />
    </Svg>
  );
}
